...
with col2:
    st.markdown("**2. Enter Voucher Size**")
    st.markdown("Enter the bedroom size on your client's voucher. This determines the maximum payment standard.")

with col3:
    st.markdown("**3. Search & Filter**")
    st.markdown("Search by town or ZIP code. Only listings within the payment standard are shown.")

st.markdown("---")

# About payment standards
with st.expander("About Payment Standards"):
    st.markdown("""
    **Payment Standards** are the maximum amounts that Housing Authorities will pay for rent
    in specific areas. They are based on HUD Fair Market Rents (FMRs) and vary by:
